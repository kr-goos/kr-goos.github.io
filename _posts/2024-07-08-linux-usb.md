...
```
![fdisk-l](../assets/img/posts/linuxusb/fdisk-l.png)
### USB 디스크 식별 방법
...
```
![lsblk-f](../assets/img/posts/linuxusb/lsblk-f.png)
...
```
![mkdir-p](../assets/img/posts/linuxusb/mkdir-p.png)
...
```
![lsblk-f](../assets/img/posts/linuxusb/mount.png)
