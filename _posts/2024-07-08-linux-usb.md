...
image:
  path: /img/posts/server-usb.jpeg
  alt: server-usb
---
...
```
![fdisk-l](/img/posts/linuxusb/fdisk-l.png)
### USB 디스크 식별 방법
...
```
![lsblk-f](/img/posts/linuxusb/lsblk-f.png)
...
```
![mkdir-p](/img/posts/linuxusb/mkdir-p.png)
...
```
![lsblk-f](/img/posts/linuxusb/mount.png)
