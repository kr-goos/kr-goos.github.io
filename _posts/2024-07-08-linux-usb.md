...
image:
  path: /assets/posts/server-usb.jpeg
  alt: server-usb
---
...
```
![fdisk-l](/assets/posts/linux-usb/fdisk-l.png)
### USB 디스크 식별 방법
...
```
![lsblk-f](/assets/posts/linux-usb/lsblk-f.png)
...
```
![mkdir-p](/assets/posts/linux-usb/mkdir-p.png)
...
```
![lsblk-f](/assets/posts/linux-usb/mount.png)
