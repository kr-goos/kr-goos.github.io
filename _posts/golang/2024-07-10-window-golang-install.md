...
![aptrepo](../../assets/img/posts/golang/window-golang-install/golang_main.png)
2. Windows 용 설치 프로그램 (.msi 파일)을 다운로드
![aptrepo](../../assets/img/posts/golang/window-golang-install/golang_download_page.png)


## 2. Go 설치
1. 다운로드한 `.msi` 파일을 실행
![aptrepo](../../assets/img/posts/golang/window-golang-install/golang_msi_file.png)
2. 설치 마법사의 지시에 따라 설치 진행 **(환경 변수(GOROOT) 설정 시 설치경로 파악 필요)**
![aptrepo](../../assets/img/posts/golang/window-golang-install/go_install_path.png)
...
go version
```
![aptrepo](../../assets/img/posts/golang/window-golang-install/go_version.png)
